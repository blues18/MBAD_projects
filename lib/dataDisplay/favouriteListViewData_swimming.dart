...
class favouriteSwimmingList extends StatefulWidget {

  @override
  State<favouriteSwimmingList> createState() => favouriteSwimmingListState();
}

class favouriteSwimmingListState extends State<favouriteSwimmingList>{
          ...
          return AlertDialog(
            ...
            actions: [
              TextButton(
                  onPressed: () {
                    setState(() {
                      fsService.removedFavouriteSwimmingItem(id);
                    });
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder <List<favourite_Location>>(
        stream:fsService.getFavouriteLocation_form_Swimming_Collection(),
